...
BRANCH: DADAR - Sales Only
UPDATED: Using DADAR_ prefixed secrets for OAuth
...
class GmailReader:
    ...
    def _get_oauth_creds(self):
        ...
        print(f"DADAR_CLIENT_ID exists: {bool(os.environ.get('DADAR_CLIENT_ID', ''))}")
        print(f"DADAR_CLIENT_SECRET exists: {bool(os.environ.get('DADAR_CLIENT_SECRET', ''))}")
        print(f"DADAR_REFRESH_TOKEN exists: {bool(os.environ.get('DADAR_REFRESH_TOKEN', ''))}")

        # UPDATED: Using DADAR_ prefixed secrets
        refresh_token = os.environ.get("DADAR_REFRESH_TOKEN", "")
        client_id = os.environ.get("DADAR_CLIENT_ID", "")
        client_secret = os.environ.get("DADAR_CLIENT_SECRET", "")
        ...
        if refresh_token and client_id and client_secret:
            ...
            logger.info("OAuth credentials loaded from environment (DADAR)")
            return self._oauth_creds

        print("❌ Missing OAuth credentials!")
        raise Exception("No OAuth credentials found for DADAR branch")
